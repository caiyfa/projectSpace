...
//        if(Cache.STAGE.get(Cache.Name.ProjectEditPage)!=null){
...
//        Stage projectEditStage=new Stage();
        Label label=new Label("项目维护");
            label.setId(Cache.Tab.ProjectEdit);
            ...
            if(!multiPaneCtrl.selectTabIfExist(label)){
                Parent parent= FXMLLoader.load(FxmlAnchor.class.getResource(FxmlAnchor.projectEditPage));
...
//        UIUtil.initStage(projectEditStage,"项目维护",parent);
//        Cache.STAGE.put(Cache.Name.ProjectEditPage,projectEditStage);
//        projectEditStage.setX(Cache.STAGE.get(Cache.Name.MainPage).getX()+30);
//        projectEditStage.setY(Cache.STAGE.get(Cache.Name.MainPage).getY()+30);
//        projectEditStage.show();

...
import psn.base.ctrl.LoginHelperPageCtrl;
...
public class LoginHelperCSVDragDroppedHandler implements EventHandler {
    public static String cacheCSVFileName=FileUtil.getCacheDir()+File.separator+ LoginHelperPageCtrl.CSVFileName;
    @Override
    ...
    public void copyFile(File srcFile){
        ...
        try {
            ...
            e.printStackTrace();
             ...
             //清理CSV缓存
            ((LoginHelperPageCtrl) Cache.CONTROLLER.get(Cache.Name.LoginHelperCtrl)).clearCSVCache();
